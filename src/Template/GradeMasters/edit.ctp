...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $gradeMaster->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $gradeMaster->id)]
            )
        ?></li>
...
<div class="gradeMasters form large-9 medium-8 columns content">
    <?= $this->Form->create($gradeMaster) ?>
    <fieldset>
        <legend><?= __('Edit Grade Master') ?></legend>
        <?php
            ...
            echo $this->Form->control('min_marks');
