	...
	<div class="col-md-5">
		<div class="box box-primary">
			<div class="box-header with-border" >
				<?php if(!empty($id)){ ?>
					<label > Edit Disability </label>
				<?php }else{ ?>
					<label> Add Disability </label>
				<?php } ?>
			</div>
			<div class="box-body">
				<div class="form-group">	
					<?= $this->Form->create($disability,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
			...
			<div class="box-body">
        		...
        		<?php $page_no=($page_no-1)*10; ?>
				 <table id="example1" class="table">
					...
					<tbody>
						<?php $i=1; foreach ($disabilities as $disabilitie): ?>
						<tr>
							<td><?php echo ++$page_no;?></td>
							<td width="25%"><?php echo $disabilitie->name;?></td>
							<td>
								<?php
								if($disabilitie->is_deleted=='Y')
								{
									echo 'Deactive';
								}
								else{
							...
							<td class="actions" align="center">
								<?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($disabilitie->id)],['class'=>'btn btn-info btn-xs editbtn','escape'=>false, 'data-widget'=>'Edit Disability', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit Disability']) ?>
							</td>
						</tr>
					<?php $i++; endforeach; ?>
					</tbody>
