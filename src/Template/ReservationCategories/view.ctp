...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Reservation Category'), ['action' => 'edit', $reservationCategory->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Reservation Category'), ['action' => 'delete', $reservationCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $reservationCategory->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Reservation Categories'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Reservation Category'), ['action' => 'add']) ?> </li>
...
<div class="reservationCategories view large-9 medium-8 columns content">
    <h3><?= h($reservationCategory->id) ?></h3>
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Short Name') ?></th>
            <td><?= h($reservationCategory->short_name) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Full Name') ?></th>
            <td><?= h($reservationCategory->full_name) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Is Deleted') ?></th>
            <td><?= h($reservationCategory->is_deleted) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Id') ?></th>
            <td><?= $this->Number->format($reservationCategory->id) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Created By') ?></th>
            <td><?= $this->Number->format($reservationCategory->created_by) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Edited By') ?></th>
            <td><?= $this->Number->format($reservationCategory->edited_by) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Created On') ?></th>
            <td><?= h($reservationCategory->created_on) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Edited On') ?></th>
            <td><?= h($reservationCategory->edited_on) ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Student Infos') ?></h4>
        <?php if (!empty($reservationCategory->student_infos)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($reservationCategory->student_infos as $studentInfos): ?>
            <tr>
