<?= $this->Form->create('') ?>
                <table class="table table-strip">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <?php echo $this->Form->control('enquiry_no', ['type'=>'text','placeholder' => 'Enter Enquiry Number','label'=>false,'class'=>'form-control student_search','style'=>'width:100%','autofocus'=>true]);?>
                            </td>
                            <td>
