...
.form-box .body, .form-box .footer {
    ...
    <body>
        <div class="form-box text-center" id="login-box" style="width:312px !important;margin-top:30px !important">
            <?= $this->Html->image('school_logo/loginlogo.png',['style'=>'margin-bottom:45px;width:45%;'])?>
        </div>
        <div class="form-box" id="login-box" style="width:384px !important;">
            <?= $this->Flash->render() ?>
            <?= $this->Form->create('',['id'=>'form_sample_3','style'=>'border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;border-top-left-radius: 10px;border-top-right-radius: 10px;background: #fff;color: #444;']) ?>
            <div class="body" style="padding: 40px 30px 20px 30px;border-top-left-radius: 10px;border-top-right-radius: 10px;">
            ...
            <div class="footer"> 
                <?= $this->Form->button('LOGIN',['id'=>'submit','class'=>'btn btn-block','style'>'margin-bottom: 10px;']); ?>
