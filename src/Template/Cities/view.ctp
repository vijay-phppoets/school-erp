...
<div class="cities view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($city->edited_by) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= h($city->edited_on) ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Employees') ?></h4>
        <?php if (!empty($city->employees)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($city->employees as $employees): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($city->student_infos)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($city->student_infos as $studentInfos): ?>
            <tr>
