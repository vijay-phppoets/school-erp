                            ...
                            <div class="col-md-12">
                                <div id="table-container">
                                    <table class="table table-bordered" id="main_tble" style="margin-top: 20px;">
                                        ...
                                        <?php
                                        if(sizeof($students->toArray())>0)
                                        { $i=1;
                                        foreach($students as $student)
                                        {
                                        ?>
                                        <tr>
                                            <td student_id="<?php echo $student->student_infos[0]->id ;?>" section_id="<?php echo $section_id; ?>" class_id="<?php echo $class_id; ?>" stream_id="<?php echo $stream_id; ?>" medium_id="<?php echo $medium_id; ?>" exam_id="<?php echo $exam_id; ?>"><?= h($i++)?></td>
                                            <td width="10%"><?php echo $student->student_infos[0]->roll_no; ?></td>
                                            <td width="10%"><?php echo $student->scholar_no; ?></td>
                                            <td width="40%"><?php echo $student->name; ?></td>
                                            <td><?php echo $this->Form->control('total_meetings',['id'=>'TotalMeeting','class'=>'form-control input-sm Attendence','placeholder'=>'Total Meeting','label'=>false,'autofocus','required'=>'required','value'=>@$totalMeetingArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id]]); ?>    
                                            </td>
                                            <td><?php echo $this->Form->control('meetings_attended',['id'=>'MeetingsAttended','class'=>'form-control input-sm Attendence ','placeholder'=>'Meetings Attended','label'=>false,'autofocus','required'=>'required', 'value'=>@$meetingsAttendedArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id]]); ?></td>
                                        <?php if((!empty(@$meetingsAttendedArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id]))&&(@$totalMeetingArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id]))  {?>
                                            <td>
                                                <?= 
                                                round((@$meetingsAttendedArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id] * 100)/@$totalMeetingArr[@$student->student_infos[0]->id][@$medium_id][@$stream_id][@$class_id][@$section_id][@$exam_id]).'%'
                                                ?>
                                            </td>
                                       <?php }
                                       else
