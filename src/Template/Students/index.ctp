<div class="row">
    ...
    <?php if(!empty($total_admission_form)){?>
    <div class="col-lg-3 col-xs-6">
     ...
     <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
            <div class="inner">
                ...
                <p>Teacher's Leave Request</p>
            </div>
            <div class="icon">
                <i class="ion-android-plane"></i>
            </div>
            <?= $this->Html->link('More info <i class="fa fa-arrow-circle-right"></i>',['controller'=>'Leaves','action'=>'leaveApproval','teacher'=>'teacher'],['class'=>'small-box-footer','escape'=>false,'target'=>'_blank']) ?>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-maroon">
            <div class="inner">
                ...
                <p>Student's Leave Request</p>
            </div>
            <div class="icon">
                <i class="icon ion-ios-book"></i>     
            </div>
            <?= $this->Html->link('More info <i class="fa fa-arrow-circle-right"></i>',['controller'=>'Leaves','action'=>'leaveApproval','student'=>'student'],['class'=>'small-box-footer','escape'=>false,'target'=>'_blank']) ?>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-primary">
            ...
            <?= $this->Html->link('More info <i class="fa fa-arrow-circle-right"></i>',['controller'=>'students','action'=>'StudentDetail'],['class'=>'small-box-footer','escape'=>false]) ?>
        </div>
    </div>
    <?php } ?>
</div>
