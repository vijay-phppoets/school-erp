                     ...
                     <table id="example1" class="table" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                if($vehicleStation->is_deleted=='Y')
                                {
                                    echo 'Deactive';
                                }
                                else{
                                ...
                                <td class="actions">
                                    <?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($vehicleStation->id)],['class'=>'btn btn-info editbtn btn-xs','escape'=>false, 'data-widget'=>'Edit Vehicle', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit Vehicle']) ?>
