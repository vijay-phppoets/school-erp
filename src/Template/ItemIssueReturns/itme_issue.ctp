		...
		<div class="box box-primary">
			...
			<div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<div class="col-sm-4">
                            <label class="control-lable">Transaction Date<span class="required" >*</span></label>
						...
						<table class="table" id="main_table">	
							...
							<tbody id="main_tbody">
								<tr class="main_tr">
									...
									<td>
										<?php echo $this->Form->control('amount', ['style'=>'text-align:right','label' =>false,'class' => 'form-control input-sm  amount numericOnly','type'=>'text','value'=>0, 'readonly','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');", 'tabindex' => '-1']);?>
									</td>
									<td>
									</td>
								</tr>
							...
							<tfoot>
								<tr>
									...
									<td>
										<?php echo $this->Form->control('grand_total',['style'=>'text-align:right','label' => false,'class' => 'form-control input-sm grand_total','type'=>'text','readonly'=>'readonly', 'tabindex' => '-1','value'=>0,'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"]); ?>
									</td>
									<td></td>
								</tr>
							</tfoot>
