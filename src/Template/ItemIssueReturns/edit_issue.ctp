	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header with-border" >
				<label>Item Issue Edit </label>
			</div>
			<?= $this->Form->create($itemIssue, ['id'=>'ServiceForm']) ?>
			<div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<div class="col-sm-4">
                            <label class="control-lable">Transaction Date</label>
                             <?= $this->Form->control('transaction_date',['class'=>'datepicker form-control','label'=>false,'data-date-format'=>'dd-M-yyyy','placeholder'=>'Transaction Date','type'=>'text','value'=>$itemIssue->transaction_date])?>
                        </div>
						<div class="form-group col-md-4 employee hidden">
							...
							<?php echo $this->Form->control('employee_id',['options'=>$employees,'label' =>false,'class'=>'select2 ','empty'=> 'select...','required'=>'required','style'=>'width:100%','value'=>$itemIssue->employee_id]);?>
						</div>
						<div class="form-group col-md-4 student">
							...
							<?php echo $this->Form->control('student_id',['options'=>$students,'label' =>false,'class'=>'select2 ','empty'=> 'select...','required'=>'required','style'=>'width:100%','value'=>$itemIssue->student_id]);?>
						</div>
						<div class="col-md-4">
						<br/><br/>
				...
				<div class="row">
					<div class="col-sm-12" style="margin-top:10px;padding: 0px 33px 0px 33px;" id="main">
						<table class="table " id="main_table">	
							...
							<tbody id="main_tbody">
								<?php $x=0; foreach($itemIssue->item_issue_return_rows as $ItemIssueReturnRows){ ?>
								<tr class="main_tr">
								...
								<?php  $this->Form->hidden('id',['value'=>$ItemIssueReturnRows->id])?>
										...
										<input type="hidden" class="grn_id" value="<?php echo $ItemIssueReturnRows->id; ?>" />
									</td>
									<td>
							...
							<tfoot>
								<tr>
									...
									<td>
										<?php echo $this->Form->control('grand_total',['style'=>'text-align:right','label' => false,'class' => 'form-control input grand_total','type'=>'text','readonly'=>'readonly', 'tabindex' => '-1','value'=>$itemIssue->grand_total,'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"]); ?>
									</td>
									<td></td>
								</tr>
							</tfoot>
