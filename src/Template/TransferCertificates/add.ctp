        ...
        <div class="box box-primary">
           ...
           <table width="90%"  align="center"  cellpadding="0" cellspacing="0" style="font-family: 'Abel', sans-serif;" >
            ...
            <table width="90%"  align="center"  style="border-collapse:collapse;margin-top:7px;margin-bottom:12px;text-align: center;">
                ...
                <td align="left" width="20%"><?= h($tc_serial_no) ?></td>
                </td>

                <td align="left" width="15%" ><b>Admission No. :</b></td>
                <td align="left" ><?= h($studentInfo->student->scholar_no) ?></td>
                    ...
                    <div class="col-md-12">
                        <table  width="90%" border="1" align="center" style="border-collapse:collapse;background-color:#DFDFDF;font-family:font-family: 'Noto Serif', serif;">
                            ...
                            <tr>
                                ...
                                <td class="td_padd" width="20%"><?= h($studentInfo->student->name) ?></td>
                            </tr>
                            <tr>
                                <td>2.</td>
                                <td class="td_padd"><span>Father's/Guardian's Name</span></td>
                                <td class="td_padd"><?= h($studentInfo->student->father_name) ?></td>
                            </tr>
                            <tr>
                                <td>3.</td>
                                <td class="td_padd"><span>Mother's Name</span></td>
                                <td class="td_padd"><?= h($studentInfo->student->mother_name) ?></td>
                            </tr>
                            <tr>
                                <td>4.</td>
                                <td class="td_padd"><span>Nationality</span></td>
                                <td class="td_padd"><?= h($studentInfo->student->nationality) ?></td>
                            </tr>
                            <tr>
                                <td>5.</td>
                                <td class="td_padd"><span>Whether the Candidate belongs to Scheduled Caste or Scheduled Tribe</span></td>
                                <td class="td_padd"><?= h($studentInfo->reservation_category->short_name) ?></td>
                            </tr>
                            <tr>
                                <td>6.</td>
                                <td class="td_padd"><span>Date of First Admission in the school Class and Date : </span></td>
                                <td class="td_padd"><?= ($studentInfo->student->registration_date != '')?date("d-m-Y", strtotime($studentInfo->student->registration_date)):'' ?>
                                <br/>
                                    <?= h($studentInfo->student->admission_class->name) ?>
                                </td>
                            </tr>
                            <tr>
                                <td rowspan="2">7.</td>
                                <td class="td_padd"><span>Date of Birth ( in Christain Era ) according to Admission Register( In Figures ) :</span></td>
                                <td class="td_padd"><?= ($studentInfo->student->dob != '')?date("d-m-Y", strtotime($studentInfo->student->dob)):'' ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="td_padd"><span>( In Words ) :</span></td>
                                <td class="td_padd"><?= ($studentInfo->student->dob != '')?$this->Numbers->convertNumberToWord($studentInfo->student->dob->format('j')).' '.$studentInfo->student->dob->format('F').', '.$this->Numbers->convertNumberToWord($studentInfo->student->dob->format('Y')):'' ?>
                                </td>
                            </tr>
                            <tr>
                                <td>8.</td>
                                ...
                                <td class="td_padd">
                                    ...
                                    <?= $this->Form->control('last_studied_class_id',['class'=>'form-control','label'=>false,'options'=>$studentClasses,'value'=>$studentInfo->student_class_id ]) ?>
                                </td>
                            </tr>
                            <tr>
                                <td>9.</td>
                            ...
                            <tr>
                                ...
                                <td class="td_padd">
                                    <?= $this->Form->control('higher_promotion_class_id',['class'=>'form-control','label'=>false,'options'=>$studentClassesHigher,'value'=>$studentInfo->student_class_id ]) ?>
                                </td>
                            </tr>
                            <tr>
                                <td>13.</td>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <center>
                                <?php echo $this->Form->button('Create TC',['class'=>'btn button','id'=>'submit_member']); ?>
                            </center>
