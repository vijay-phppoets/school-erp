...
<style type="text/css">
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="" id="demo_table">
                <tbody>
                    <tr>
                        <td>
                            <?php echo $this->Form->control('name',['label' => false,'class'=>'form-control ','placeholder'=>'Subject Name','type'=>'text']);?>
                        </td>
                        <td>
                            <?php $options = array('Yes' => 'Yes','No'=>'No' ); ?>
                            <?php echo $this->Form->radio('elective',[
                        ...
                        <td>
                            <?php echo $this->Form->control('order_number',['label' => false,'class'=>'form-control ','placeholder'=>'Order No.']);?>
                        </td>
                        <td>
                            <?php echo $this->Form->control('subject_type_id', ['options' => $subjectTypes,'label'=>false,'class'=>'select2','style'=>'width:100%;']);?>
                        </td>
