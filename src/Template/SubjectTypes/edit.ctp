...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $subjectType->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $subjectType->id)]
            )
        ?></li>
...
<div class="subjectTypes form large-9 medium-8 columns content">
    <?= $this->Form->create($subjectType) ?>
    <fieldset>
        <legend><?= __('Edit Subject Type') ?></legend>
        <?php
