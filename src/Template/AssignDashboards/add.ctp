...
<div class="col-md-12">
    <div class="box box-primary">
        <div class="box-header with-border no-print">
            <h3 class="box-title">Assign Dashboard</h3>
        </div>
        <div class="box-body">
            <div class="col-md-12">
                        ...
                        <?php echo $this->Form->create($userRight, ['url'=>['action'=>'addEmployeeRights'],'type' => 'post','class'=>'form-horizontal']); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    echo $this->Form->control('employee_id', ['empty'=> '--Select--','data-placeholder'=>'Select ID...','label' => false,'class'=>'select2','style'=>'width:100%;','id'=>'employee_id','required'=>true,'option'=>$employees]); ?>
                            ...
                            <?= $this->Form->unlockField('dashboard_section_id') ?>
