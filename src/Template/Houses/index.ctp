		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="form-group">	
					<?= $this->Form->create($house,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<table id="example1" class="table">
					...
					<tbody>
						<?php $i=1; foreach ($Houses as $House): ?>
						<tr>
							<td><?php echo ++$page_no;?></td>
							<td width="25%"><?= h($House->name) ?></td>
							<td>
							<?php
							if($House->is_deleted=='Y')
							{
								echo 'Deactive';
							}
							else{
							...
							<td class="actions" align="center">
								<?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($House->id)],['class'=>'btn btn-info btn-xs editbtn','escape'=>false, 'data-widget'=>'Edit House', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit House']) ?>
							</td>
						</tr>
						<?php $i++; endforeach; ?>
					</tbody>
