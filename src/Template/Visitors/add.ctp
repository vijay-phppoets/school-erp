                         ...
                         <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <label class="radio-inline" id="student">
                                    <input type="radio" id="option1" value="Student" name="whom_to_meet" checked > Student
                                </label>
                                <label class="radio-inline" id="employee">
                                    <input type="radio" id="option2" value="Employee" name="whom_to_meet"> Employee
                                </label>
                            </div>
                        </div>
                     </div>
                                ...
                                <div class="col-md-4 student">
                                    <div class="row">
                                        <div class="col-md-12">
                                           ...
                                           <?= $this->Form->control('student_id', ['options' => $students, 'empty' => '--Select--','class'=>'','label'=>false,'id'=>'student-id','style'=>'width:100%','required'=>true]);?>
                                        </div>
                                    </div> 
                                </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                           ...
                                           <?= $this->Form->control('visitor_type',array('options' => $visitor_types,'class'=>'select4','label'=>false,'style'=>'width:100%','empty'=>'Select Option','required')) ?>
                                        </div>
                                    </div> 
                                </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?= $this->Form->control('id_card', ['label' => false, 'class'=>'form-control ','type'=>'text','placeholder'=>'Enter Id Card Name','required'])?>
                                        </div>
                                    </div> 
                                </div> 
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                          ...
                                          <?= $this->Form->control('id_card_no', ['label' => false, 'class'=>'form-control ','type'=>'text','placeholder'=>'Enter Id Card Number','required'])?>
                                        </div>
                                    </div> 
                                </div> 
                            </div> 
                            <div class="row">
                                 ...
                                 <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?= $this->Form->control('city_id',array('options' => $cities,'class'=>'select4','label'=>false,'style'=>'width:100%','empty'=>'Select City','required')) ?>
                                        </div>
                                    </div> 
                                </div> 
                                <div class="col-md-4">
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <?= $this->Form->control('address', ['label' => false, 'class'=>'form-control ','type'=>'textarea','placeholder'=>'Enter Address','rows'=>'2','style'=>'resize:none;'])?>
                                </div> 
                            </div>
                           <div class="row">
                                <fieldset>
                                    ...
                                    <div class="col-md-12">
                                        <?php echo $this->Form->hidden('photo',[
