		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="form-group">    
					<?= $this->Form->create($stream,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
					...
					<tbody>
						...
						<tr>
							...
							<td class="actions" align="center">
								<?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($stream->id)],['class'=>'btn btn-info btn-xs editbtn','escape'=>false, 'data-widget'=>'Edit Stream', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit Stream']) ?>
							</td>
						</tr>
						<?php $i++; endforeach; ?>
					</tbody>
