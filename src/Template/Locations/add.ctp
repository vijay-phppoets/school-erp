		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="form-group">	
					<?= $this->Form->create($location,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<table id="example1" class="table table-str table-striped" style="border-collapse:collapse;">
					...
					<tbody>
						<?php $x=0; foreach ($locations as $location){?>
						<tr>
							<td><?= ++$x; ?></td>
							...
							<td class="actions" >
                               <?php echo $this->Html->image('editicon.png',['url'=>['controller'=>'Locations','action'=>'add',$EncryptingDecrypting->encryptData($location->id)],'class'=>'tooltips showLoader','data-original-title'=>'Edit location','data-container'=>'body','data-widget'=>'Edit location',]);?>
							</td>
						</tr>
						<?php } ?>
					</tbody>
