        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border" >
                    <i class="fa fa-hand-o-right fas" style="float:none !important;"></i> <label> Sports Gallery </label>
                </div>
                <div class="box-body">
                    <div class="row" style="padding-top:10px">
                        <?= $this->Form->create('dsad',['id'=>'ServiceForm','type'=>'file']) ?>
                            <div class="col-md-4">
                                ...
                                'label' => false,'class'=>'form-control sports_id','empty'=>'Select All','options' => $CategoriesList]);?>
                            </div> 
                            <div class="col-md-4">
                    ...
                    if(!empty($searchData)){
                        $s=1;
                        foreach ($searchData as $key => $galleryDatas) {
                            ...
                            <div class="col-md-3" style="padding-top:10px">
                                <table style="text-align:center">
                                    ...
                                    <tr><td>&nbsp; <h4><?php echo $galleryDatas->sport->name;?></h4></td> </tr>
                                    ...
                                    <div id="deletemodal<?php echo $galleryDatas->id; ?>" class="modal fade" role="dialog">
                                        ...
                                        <?= $this->Form->create('',['url'=>['controller'=>'Sports','action'=>'delete',$galleryDatas->id]]) ?>
