                 ...
                 <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="15%"><?php echo @$syllabus->medium->name;?></td>
                            <td width="15%"><?php echo @$syllabus->student_class->name;?></td> 
                            <td width="15%"><?php echo @$syllabus->stream->name;?></td> 
                            <td width="15%"><?php echo @$syllabus->section->name;?></td> 
                            <td width="15%"><?php echo @$subject_name;?></td> 
                            <td width="15%">
                            ...
                            <td> 
                            <a href="#myModal<?= $syllabus->id ?>" class="btn btn-info " data-toggle="modal" /> <i class="fa fa-trash-o"></i></a>
                            
                                <div id="myModal<?= $syllabus->id ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog modal-dialog">
                                        <div class="modal-content">
                                            <?= $this->Form->create('',['url'=>['action'=>'delete',$syllabus->id]]) ?>
                                          ...
                                          <div class="modal-body">
                                           <h4> Are you sure, you want to delete this syllabus?</h4>
                                            <?php echo $this->Form->hidden('syllabus_id',[
                                                  'value'=>$syllabus->id]);?>
                                          </div>
