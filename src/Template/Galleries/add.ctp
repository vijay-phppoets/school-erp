...
<div class="row">
                        ...
                        <!-- <div class="row">
                            <fieldset><legend>Event Schedule</legend>
                                ...
                                <table style="width:80%;align:center" class="table table-bordered table-hover" id="parant_table" >
                                    ...
                                    'label' => false,'class'=>'form-control name','placeholder'=>'*Name','type'=>'text','required']);?>
                                        </td>
                                        <td>
                                            <?php echo $this->Form->control('ss',[
                                    'label' => false,'class'=>'form-control datepicker schedule_date','placeholder'=>'Date','type'=>'text','data-date-format'=>'dd-mm-yyyy','required']);?>
                                             
                                        </td>
                                        <td>
                                            <div class="bootstrap-timepicker"> 
                                                <?php echo $this->Form->control('ss',[
                                    'label' => false,'class'=>'form-control timepicker schedule_time','placeholder'=>'Time','type'=>'type','required']);?>
                                            </div> 
                                        </td>
                                        <td>
 ...
 -->
                        <div class="row">
                            <fieldset><legend>Event Images</legend>
                                <center>                        
                                <table style="width:80%;align:center" class="table table-bordered table-hover" id="parant_table2" >
                                    <thead>
                                        <tr style="background-color:#8a8a8a2e;">    
