    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border" >
                <i class="fa fa-hand-o-right fas" style="float:none !important;"></i> <label> Audio List </label>
            </div>
            <div class="box-body">
                <table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions"><a class=" btn btn-primary btn-sm" download="download" href="<?= $cdn_path.'/'.$gallery->cover_image ?>" ><i class="fa fa-download"></i></a></td>   
                            <td class="actions">
