                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <hr style="margin-top: 12px;margin-bottom: 10px;"></hr>
                                    <!-- <a href="<?php echo $this->Url->build(array('controller'=>'Galleries','action'=>'index')) ?>"class="btn btn-danger btn-sm">Reset</a> -->
                ...
                <table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'edit', $EncryptingDecrypting->encryptData($gallery->id)],['class'=>'btn btn-info editbtn btn-xs','escape'=>false, 'data-widget'=>'Edit', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
