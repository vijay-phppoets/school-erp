<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<?= $this->Form->create($vehicleRoute, ['id'=>'ServiceForm']) ?>
			<div class="portlet-body">
				<div class="row" style="margin-top:10px;padding: 0px 33px 0px 33px;">
						<div class="col-md-4">
						</div>
						<div class="col-md-4">
							<?= $this->Form->control('vehicle_id', ['options' => $vehicles,'label' => false, 'class'=>'select2','style'=>'width:100%','empty'=>'Select Vehicle','dataplaceholder'=>'Select Vehicle','required'])?>
						</div>
						<div class="col-md-4">
						</div>
					</div>
						...
						<table class="table " id="main_table">	
							...
							<tbody id="main_tbody">
								<tr class="main_tr">
									...
									'label' => false,'class'=>'select2','empty'=>'Select Station','style'=>'width:300px;','required']);?></td>
									</td>
