                ...
                <div class="box-body">
                    <?= $this->Form->create($vehicleFuelEntry,['id'=>'form_sample_3','type'=>'file']) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">                         
                                <div class="form-group">
                                    <label class="control-label">Previous Km
                                        <span class="required" style="color: red;">*</span>
                                    </label>
                           ...
                           <div class="row">
                              <div class="col-md-4">                         
                                <div class="form-group">
                                    ...
                                    <?= $this->Form->control('milege', ['label' => false, 'class'=>'form-control ','placeholder'=>'Enter Milege','type'=>'text','required'])?>
                                </div>
                            </div>
                            <div class="col-md-8">                         
                                <div class="form-group">
                                    <label class="control-label">Remarks<span class="required" style="color: red;">*</span>
