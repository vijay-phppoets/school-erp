        ...
        <div class="box box-primary">
           <div class="box-header with-border" >
            ...
            <?= $this->Form->create($feeReceipt,['class'=>'FormSubmit','id'=>'ServiceForm']) ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                         <label class="control-label"> Detail <span class="required" aria-required="true"> * </span></label>
                         <?= $this->Form->control('detail', ['label' => false, 'class'=>'form-control','required'=>true,'placeholder'=>'Detail about non-scholar','rows'=>2])?>
                    </div>
                </div>
            ...
            <tbody>
                ...
                foreach ($SubmittedFee as $Submittedlist) {
                    ...
                    <tr>
                        ...
                        <td> 
                            <?= $this->Html->link('<i class="fa fa-print"></i>',['controller'=>'FeeReceipts','action'=>'receiptPrint','FeeReceipts','adhocFeeNonscholar',$receipt_id],['escape'=>false,'class'=>'btn btn-primary btn-xs']) ?>
...
<div id="deletemodal<?php echo $Submittedlist->id; ?>" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md" >
        <?= $this->Form->create('from',['url'=>['action'=>'delete','adhocFeeNonscholar',$receipt_id]]) ?>
            <div class="modal-content">
              <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
