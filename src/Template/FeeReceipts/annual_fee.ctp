        ...
        <div class="box box-primary">
            <div class="box-header with-border" >
                ...
                <div class="box-tools pull-right">
                  <?= $this->Html->link('Student Edit',['controller'=>'Students','action'=>'editStudent',$student_id,'FeeReceipts','annualFee'],['class'=>'btn btn-warning','style'=>'color:#FFF !important;']) ?>
                </div>
            </div>
            <div class="box-body">
            <?= $this->Form->create($feeReceipt,['class'=>'FormSubmit','id'=>'ServiceForm']) ?>
                <?= $this->Form->control('fee_category_id',['label' => false,'type'=>'hidden','value'=>4])?>
  ...
  <div class="modal-dialog" style="width: 75%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Annual Fee Receipt</h4>
      </div>
            ...
            <tbody>
                ...
                foreach ($SubmittedFee as $Submittedlist) {
                    ...
                    <tr>
                        ...
                        <td> 
                            <?= $this->Html->link('<i class="fa fa-print"></i>',['controller'=>'FeeReceipts','action'=>'receiptPrint','FeeReceipts','annualFee',$receipt_id,$student_info_id],['escape'=>false,'class'=>'btn btn-primary btn-xs']) ?>
...
{ 
    ...
    <div id="deletemodal<?php echo $Submittedlist->id; ?>" class="modal fade" role="dialog">
        <div class="modal-dialog modal-md" >
            <?= $this->Form->create('from',['url'=>['action'=>'delete','annualFee',$receipt_id,$student_info_id]]) ?>
                <div class="modal-content">
                  <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
