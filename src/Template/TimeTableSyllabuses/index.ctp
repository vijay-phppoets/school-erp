        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border" >
                    <label>Exam Time Table View</label>
                </div>
                <!-- <?= $this->Form->create('dasd',['id'=>'ServiceForm']) ?> -->
                <form method="get">
                <div class="box-body">
                ...
                <div class="row" style="padding-top:0px">
                    ...
                    if(!empty($timeTableSyllabuses)){
                        ...
                        <table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $x=0; foreach ($timeTableSyllabuses as $timeTableSyllabus): ?>
                                <tr>
                                    <td><?= ++$x ?></td>
                                    <td><?= @$timeTableSyllabus->medium->name ?></td>
                                    <td><?= @$timeTableSyllabus->student_class->name?></td>
                                    <td><?= @$timeTableSyllabus->stream->name ?></td>
                                    <td><?= @$timeTableSyllabus->section->name ?></td>
                                    <td><?= @$timeTableSyllabus->subject->name ?></td>
                                    <td><?= h($timeTableSyllabus->date) ?></td>
                                    <td><?= h($timeTableSyllabus->time_from) ?></td>
                                    <td><?= h($timeTableSyllabus->time_to) ?></td>
                                    
                                    <!-- <td><?= $timeTableSyllabuses->employee->name ?></td>  -->
                                    <td class="actions">
                                        <a class=" btn btn-danger btn-sm" data-target="#deletemodal<?php echo $timeTableSyllabus->id; ?>" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                        <div id="deletemodal<?php echo $timeTableSyllabus->id; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog modal-md" >
                                            <?= $this->Form->create('',['url'=>['controller'=>'TimeTableSyllabuses','action'=>'delete',$timeTableSyllabus->id]]) ?>
