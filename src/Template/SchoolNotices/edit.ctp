                    ...
                    <?= $this->Form->create($schoolNotice,['id'=>'ServiceForm','type'=>'file']) ?>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                'label' => false,'class'=>'form-control datepicker','placeholder'=>'Date','type'=>'text','data-date-format'=>'dd-mm-yyyy','required','value'=>date('d-m-Y',strtotime($schoolNotice->valid_date))]);?>
                            </div>   
                        </div>
