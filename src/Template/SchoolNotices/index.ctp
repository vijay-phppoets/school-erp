                        ...
                        <div class="col-md-12">
                            <div class="row"> 
                                ...
                                <hr style="margin-top: 12px;margin-bottom: 10px;"></hr>
                                    <!-- <a href="<?php echo $this->Url->build(array('controller'=>'SchoolNotices','action'=>'index')) ?>"class="btn btn-danger btn-sm">Reset</a> -->
                        ...
                        <tr>
                            ...
                            <td>
                               <?php 
                                    ...
                                    if ($schoolNotice->is_deleted =='Y') {
                                        
                                         echo $this->Form->button('Deactive',['class'=>'btn btn-xs btn-danger']); 
                                    }
                                    elseif($schoolNotice->is_deleted =='N')
                                    {
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'edit', $EncryptingDecrypting->encryptData($schoolNotice->id)],['class'=>'btn btn-info editbtn btn-xs','escape'=>false, 'data-widget'=>'Edit', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
