		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="form-group">    
					<?= $this->Form->create($section,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
					...
					<tbody>
						...
						<tr>
							...
							<td class="actions" align="center">
								<?= $this->Html->link(__('<i class="fa fa-pencil"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($section->id)],['class'=>'btn btn-info btn-xs editbtn','escape'=>false, 'data-widget'=>'Edit Section', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit Section']) ?>
							</td>
						</tr>
					<?php $i++; endforeach; ?>
					</tbody>
