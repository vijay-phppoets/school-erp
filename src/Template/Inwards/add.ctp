							...
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-12">
									   ...
									   <?= $this->Form->control('bill_no', ['label' => false, 'class'=>'form-control ','type'=>'text','placeholder'=>'Enter Bill Number','required'])?>
									</div>
								</div> 
							</div> 
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-12">
									   ...
									   <?= $this->Form->control('person_name',array('class'=>'form-control','label'=>false,'placeholder'=>'Enter Person Name','required'=>true,'oninput'=>"this.value = this.value.replace(/[^a-z A-Z.]/g, '').replace(/(\..*)\./g, '$1');")) ?>
									</div>
								</div> 
							</div> 
							  <div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-12">
										...
										<?= $this->Form->control('party_name', ['label' => false, 'class'=>'form-control ','type'=>'text','placeholder'=>'Enter Party Name','required'])?>
									</div>
								</div> 
							</div> 
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-12">
										...
										<?= $this->Form->control('department_id',array('options' => $departments,'class'=>'select2','label'=>false,'style'=>'width:100%','empty'=>'Select Department','required')) ?>
									</div>
								</div> 
							</div> 
						 </div> 
