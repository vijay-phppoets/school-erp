...
-->			<?php if($marks_type !== 'Grade'){?>		 <tr class="header_font">
                                            ...
                                            <?php $grand_total=0; if($ccf['examcol']) { foreach ($ccf['examcol'] as $sub_key => $scholastic_subject){
												?>
...
<?php }?>
				...
				{ 
				?>
				<table width="100%"  border="1" style="margin-top:0px;margin-bottom: -5px;" cellspacing="0" cellpadding="0" >
					<tr>
					<td width="70%">
