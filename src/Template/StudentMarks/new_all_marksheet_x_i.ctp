...
.a1
{height: auto; border: 1px solid; font-family: Arial, Helvetica, sans-serif; page-break-inside: avoid !important;}
...
.third-table-style { 
    text-transform: uppercase;margin-top: 8px;width: 100.2%;border-left: unset;
}
...
<?php $totleopten=[];$totleoptentotle=[];$examid=[];$componentData=[];$url=$awsFileLoad->cdnpath();?>

<?php foreach($getStudentsList as $idx => $studentInfo): ?>

    <?php $totleoptens = []; $totleoptentotles = []; $countofsulimetri = 0; ?>

    <section><div class="portlet light"><div style="background: white;"><div class="row">
        <div class="col-md-12"><div class="box box-primary">
            <div class="box-header with-border"></div> 
            <div class="box-body">
                    <div class="a1"><div class="row">
                            ...
                            <tr>
                                ...
                                <td width="66%">
						            ...
						            <div style="font-size:21px; margin-top:0px; text-align:center;">
                                        <strong><b style = "font-family:Georgia; font-size:20px;">Record of Academic Performance</b>
                                            Session : <?= $getSessionName;?></strong>
                                    </div>
                                </td>
                                <td width="15%">
                                    <?php echo $this->Html->image($url.'/'.$studentInfo->student_image, array('width' => '140','height'=>140)); ?>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <table height="100" style="width:100%;margin-top:20px; font-size:14px;font weight:bold;text-transform: uppercase;" cellpadding="1" border="0" cellspacing="10">
                            <tr align="left">
                                ...
                                <th> : &nbsp; <strong ><?= $studentInfo->student->name?></strong> </th>
                                <th style="width:15%">Scholar No.</th>
                                <th style="width:55%" align="left">: &nbsp;<?= $studentInfo->student->scholar_no?></th>
                            </tr>
                            <tr align="left">
                                <th class="firstTH">Father's Name</th>
                                <th>: &nbsp; <strong > <?= $studentInfo->student->father_name?></strong></th>
                                <th>Roll No.</th>
                                <th> : &nbsp; <?= $studentInfo->roll_no?></th>
                            </tr>
                            <tr align="left">
                                <th class="firstTH">Mother's Name</th>
                                <th> : &nbsp; <strong ><?= $studentInfo->student->mother_name?></strong></th>
                                <th>Class </th>
                                <th> : &nbsp; <?= $studentInfo->student_class->roman_name?></th>
                            </tr>
                            <tr align="left">
                                <th style="width:15%" class="firstTH">DOB</th>
                                <th style="width:55%" align="left">: &nbsp; <?= $studentInfo->student->dob?></th>
                                <th style="width:15%">Section</th>
                                <th align="left"> : &nbsp; <?= $studentInfo->section->name ?></th>
                            </tr>
                        </table>
                    </div>

                    <div class="col-xs-12">
                        <table class="table-new third-table-style" cellpadding="0px" border="1" id="sample_1">
                            <tbody>
                                ...
                                <?php $maxDepth = $Find->maxDepth($storeStudentExams); $itteration = $maxDepth;?>
                                <?php $examLength=0; ?>
                                <?php $examArray = $storeStudentExams; $exams2 = $examArray; $examArray = $Find->nextChild($exams2);?>

                                    <!-- Scholastic Area Header Start ----------------------------------------------->
									...
									<?php for ($i=0; $i < $itteration; $i++): ?>
										<tr class="header_font second_color">
										    ...
										    <?php foreach ($examArray as $key => $section): ?>
										        <?php if($i!=0): ?> <th><p><?= $section['name'] ?></p></th><?php endif; ?>
										    <?php endforeach; ?>
										
                                            <?php if ($studentInfo->student_class->grade_type != 'Grade'): ?>
										        <?php   if($i!=0){ ?>
										            <th><p> Total</p></th>
										        <?php } if ($studentInfo->student_class->grade_type != 'Number'):?>  
                                                    <?php if($i!=0){ ?>
										            <th><p> Grade</p></th>
										<?php } endif; ?>
										<?php endif; ?>
                                    ...
                                    <!-- Scholastic Area Header End ----------------------------------------------->

                                    <!-- Scholastic Area Data Start ----------------------------------------------->

                                    <?php  
                                        $maxWidth = $Find->maxWidth($storeScholasticSubjects[$idx]);
                                        $maxDepth = $Find->maxDepth($storeScholasticSubjects[$idx]);
                                    ?>
                                    <?php foreach ($storeScholasticSubjects[$idx] as $sub_key => $scholastic_subject):?>

                                        <?php $student_subjectparnt['name'] = $scholastic_subject; ?>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <?php foreach ($scholastic_subject['children'] as $sub_key => $scholastic_subject): ?><!-- each-a -->
                                                <?php $currentDepth =  $Find->arrayDepth($scholastic_subject);?>
                                                <?php $colSpan = $maxDepth - $currentDepth;?>
                                                <?php $a[0] = $scholastic_subject; ?>
                                                <?php $rowspan = $Find->maxWidth($a); ?>
                                                ...
                                                <?php if(empty($scholastic_subject['children'])):?><!-- if-c -->
                                                ...
                                                <?php foreach ($scholastic_subject['exams'] as $exam_key => $exam):?>
                                                    <td style="font-size:14px;padding:10px">
                                                        <?php foreach ($storeStudentMarks[$idx] as $key => $result): ?>
                                                        <?php $fail = explode(',',$result->fail); ?>
                                                        <?php $supplementary = explode(',',$result->supplementary); ?>
                                                        <?php if ($result->exam_master_id == $exam['id'] && $result->subject_id == $subject_id): ?>
                                                            <?php 
                                                                                             
                                                                echo '<p style="padding: 5px;">'. $result->student_number;
                                                                echo '/'.$result->marksmax .'</p>';
                                                                $subject_total += (int) $result->student_number;
                                                                $total         += (int) $result->marksmax;
                                                ...
                                                <?php if ($studentInfo->student_class->grade_type != 'Grade'): ?><!-- if-b -->
												<?php 
												...
												?>
                                                    ...
                                                    <?php if ($studentInfo->student_class->grade_type != 'Number'): ?><!-- if-a -->
                                                    <th style="text-align: center;font-size:14px;">
                                                        <?php $subject_per = $subject_total*100/$total; $subject_per1=round($subject_per); ?>
													    <?php foreach($getGradeMasters as $infog){
														            if(in_array($subject_per1, range($infog->min_marks, $infog->max_marks)) ){ echo $infog->grade;}
														        }
													    ?>
                                                    </th>    
                                                    <?php endif; ?><!-- if-a end -->
                                                ...
                                                <?php endif; ?><!-- if-c -->
                                            <tr>
                                            <?php endforeach; $hello=0;?> <!-- each-a end -->
																	...
																	?>
                                                                        ...
                                                                        <?php foreach ($result['result_rows'] as $key => $result_row): ?>
                                                                            ...
                                                                            <?php if ($result_row->exam_master_id == $exam['id'] && $result_row->subject_id == $subject_id ): ?>
                                                                                    <?php 
                                                                                        if($studentInfo->student_class->grade_type == 'Grade')
                                            ...
                                            <?php /* $ccf=abc($scholastic_subjects,$Find,$marks,$studentInfo->student_class->grade_type,$infogread); */ ?>
...
-->		
	...
	<?php   if($studentInfo->student_class->grade_type !== 'Grade'){ ?>		 <tr class="header_font">
										   ...
										   $componentData['percentage']=round($totlepersent,2);
                                                  @$totlepe= round($totlepersent);
                                                   foreach($getGradeMasters as $infog)
																	{
...
<?php } $prrj=0;$rjpr=0;?>										
      ...
      <?php if($studentInfo->student_class->grade_type != 'Grade'){?>
                        <div class="row row-eq-height">
                            <?php if (!empty($storeNoneScholasticSubjects[$idx])): ?>
                                <?php 
                                    $type = '';
                                    $part = 1;
                                    $length = count($storeNoneScholasticSubjects[$idx]);
                                 ?>
                                <?php foreach ($storeNoneScholasticSubjects[$idx] as $key => $subject): ?>
                                    <?php 
									//pr($storeNoneScholasticSubjects);
			...
			<table border="1"  cellspacing="0" cellpadding="0" style="width: 100.2%;border-left: unset;text-transform: uppercase;margin-bottom: 4px;margin-top: -6px;" >
                ...
                <tr class="header_font second_color">
                    ...
                    <th width="20%" rowspan="4" style="background-color:#FFF !important;text-align:center;">
					    <?= $this->Html->image('ALOK SENIOR SECONDARY SCHOOL  HIRAN MAGRI, SECTOR - 11, Udaipur  CBSE, NEW DELHI, AFFILIATION NO.-1730007.png', array('width' => '115px')); ?>
                    </th>
                </tr>
                <tr class="header_sub">
                    <th height="46px" style="text-align:center;">
                        <?= $getClassMappingAndEmployee['Employees']['name'];?>
                    </th>
                    <th style="text-align:center;">Mr. Anil Mehta</th>
                    <th style="text-align:center;">Mr. Shashank Taunk</th>
                    <th style="text-align:center;">Mr. <?= $studentInfo->student->father_name?> </th>
                </tr>
                <tr>
                    <td height="45px"></td>
            ...
            <table border="1"  cellspacing="0" cellpadding="0" style=" border-left: unset; width: 100.2%;text-transform: uppercase;margin-top: -6px;">
                ...
                <tr class="header_sub">
                    <th height="45px" style="text-align:center;">
                        <?php echo $storeStudentExamAttendances[$idx][0]->total_meeting; $componentData['meeting'] = $storeStudentExamAttendances[$idx][0]->total_meeting; ?>
                    </th>
                        
                    <th style="text-align:center;">
                        <?php echo $storeStudentExamAttendances[$idx][0]->attend_meeting; $componentData['attend'] = $storeStudentExamAttendances[$idx][0]->attend_meeting; ?>
                    </th>
					<?php  $Percentageatt = $storeStudentExamAttendances[$idx][0]->attend_meeting*100/$storeStudentExamAttendances[$idx][0]->total_meeting;?>
                                        
                    <th style="text-align:center;"><?php if($Percentageatt){echo round(@$Percentageatt,2);}?></th>
										
                    <th style="text-align:center;">
                        <?php if($Percentageatt >= 90 && $Percentageatt <= 100)   { echo "Excellent"; }    ?>
                        <?php if($Percentageatt >= 80 && $Percentageatt <= 89.99) { echo "Very Good"; }    ?>
                        <?php if($Percentageatt >= 75 && $Percentageatt <= 79.99) { echo "Good";	  }    ?>
                        <?php if($Percentageatt <= 74.99 && $Percentageatt >= 1)  { echo "Insufficient"; } ?>
                        <?php if(empty($Percentageatt)) { echo ""; } ?> 
                    </th>
                </tr>
            </table>
        
            <!-- Attendance table closed :)  -->    
        <?php endif; ?>
					...
					<td width="70%">
						...
						if(@$countofsulimetri>0 && @$countofsulimetri<=1)
							...
							<tr>
								...
								$bz=@$studentInfo->student_class->roman_name;$k=0;
								...
								$component->insertData($componentData);
								?>
								</td>
							</tr>
						</table>
                        ...
                        <div class="row row-eq-height">
                            ...
                            <?php if (!empty($storeNoneScholasticSubjects[$idx])): ?>
                                <?php 
                                    ...
                                    $part = 1;
                                    $length = count($storeNoneScholasticSubjects[$idx]);
									//pr($storeNoneScholasticSubjects);die;
									$j=0;
                                 ?>
    ...
    border-left: unset;" >
										...
										<?php } ?>
													...
													{
													?>
													<th class="header_font second_color" style="width: 25%;text-align: center !important;padding: 6px;font-weight: 600 !important;font-weight: 600!important;" ><?php if ($studentInfo->student_class->grade_type != 'Grade'){?>Term  I<?php }else{?>Report  I<?php }?></th>
													<?php }else{?>
													<th class="header_font second_color" style="width: 12%;text-align: center !important;padding: 6px;font-weight: 600 !important;font-weight: 600!important;" ><?php if ($studentInfo->student_class->grade_type != 'Grade'){?>Term  I<?php }else{?>Report  I<?php }?></th>
													<th class="header_font second_color" style="width: 12%;text-align: center !important;padding: 6px;font-weight: 600 !important;font-weight: 600!important;" ><?php if ($studentInfo->student_class->grade_type != 'Grade'){?>Term  II<?php }else{?>Report  II<?php }?></th>
...
<div class="row row-eq-height">
           ...
           <table cellspacing="0px" cellpadding="0px" border="1" id="sample_1" style="text-transform: uppercase;margin-top: -3px;width: 100.2%;border-left: unset;" >
					...
					?></td>
								...
								<?php } ?>
                      <?php if($studentInfo->student_class->grade_type != 'Grade'){?>
                        <div class="row row-eq-height mg-css">
                            <div class="col-xs-5">
    ...
    width: 100.3%;" >
					  ...
					  <?php }?>
					   <?php if($studentInfo->student_class->grade_type == 'Grade'){
						 if(!empty($storeNoneScholasticSubjects[$idx])){
						 ?>
