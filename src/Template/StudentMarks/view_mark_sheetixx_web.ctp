...
-->			<?php if($marks_type !== 'Grade'){?>		 <tr class="header_font">
                                            ...
                                            <?php $prj=0; $grand_total=0; if($ccf['examcol']) { foreach ($ccf['examcol'] as $sub_key => $scholastic_subject){
												?>
                                           ...
                                           $prj++; } }?>
                                           <th><p><?php echo @$OverAllTotalnum;?>/<?php echo @$OverAllTotalmax; ?></p></th> 
                                           <th><p ><?php  @$totlepersent=$OverAllTotalnum*100/ $OverAllTotalmax;
