...
//pr($student);die;
$totleopten=[]; 
$attendance1=0;$meeting1=0;
					$attendance2=0;$meeting2=0;
					$attendance3=0;$meeting3=0;
					$per1 = 0;
					$per2 = 0;
					$per3 = 0;
															$totleoptentotle=[]; 
															...
															$countofsulimetri=0; 
   $sublimenterysubject=[]; 
   $passtobeneed=0;$passtoneedallmarks=0;
											
		$componentData=[];									$class_to_promotion =array("Nursery",'KG','PREP', "I","II","III", "IV","V","VI","VII","VIII","IX","X","XI","XII");
	?>
                                       ...
                                       <!-- <?php if ($marks_type != 'Grade'): ?>
                                        ...
                                        <?php /* $infogread=($infogread->toArray());  */
											//pr($infogread);die;
                                                ...
                                                <?php 
												if( $scholastic_subject['elective'] == 'Yes' &&
												    $scholastic_subject['id'] != $student->student_elective_subjects[0]->subject_id){
												   continue;
												} 
												?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="20%" class="subjects" rowspan="<?= $rowspan==0?'':$rowspan ?>" colspan="<?= $colSpan==0?'':$colSpan ?>">
														
														
												
														
														
														<p style="text-align: left!important;margin-left: 4px !important;  padding: 10px 0 !important;"><?= $scholastic_subject['name'] ?> </p></th>
                                                                ...
                                                                <td style=" font-size: 14px;">
																	...
																	?>
                                                                        ...
                                                                        <?php foreach ($result['result_rows'] as $key => $result_row): ?>
																			...
																			if(strtoupper($scholastic_subject['name'])!="COMPUTER")
																{								
...
-->		
	...
	<?php   if($marks_type !== 'Grade'){ ?>		 <tr class="header_font">
                                            ...
                                            <th ><p style="text-align: left!important;padding-left: 5px;padding: 4px;">Total
                                            ...
                                            <?php $grand_total=0; if($examid) { foreach ($examid as $sub_key => $scholastic_subject){
                                                ...
                                                <th style=" font-size: 14px;"><p><?php @$prrj+=$totleopten[$sub_key];@$rjpr+=$totleoptentotle[$sub_key]; echo $totleopten[$sub_key];?>/<?php echo $totleoptentotle[$sub_key];?></p></th>
                                               <?php
                                            } }?>
											<?php $passtobeneed=@$prrj;$passtoneedallmarks=@$rjpr;
											$componentData['marks']=$passtobeneed;
											$componentData['marksmax']=$passtoneedallmarks;
											
											?>
                                           <th style=" font-size: 14px;"><p><?php echo @$prrj;?>/<?php echo @$rjpr; ?></p></th> 
                                           <th style=" font-size: 14px;"><p><?php  @$totlepersent=$prrj*100/ $rjpr;
...
<?php } $prrj=0;$rjpr=0;?>										
    ...
    border-left: unset;" >
                                    ...
                                    <?php } ?>
                                        <tr>
                                          ...
                                          if($markss['student_info_id']==$student->id)
										  {             
											?>
	  ...
	  <?php } ?>
                      ...
                      <div class="row">
							...
							<table border="1"  cellspacing="0" cellpadding="0" style="width: 100.2%;border-left: unset;text-transform: uppercase;margin-bottom: 4px;margin-top: -6px;" >
                                    <tr class="header_font main_color" >
                                        <th height="20" colspan="102" style="margin-left:5px;text-align:center;padding: 4px;color: white;">Signature</th>
                                    </tr>
                                    <tr class="header_font second_color">
                                        <th height="30" style="text-align:center;">Class Teacher</th>
                                    ...
                                    <tr class="header_sub">
                                        <th height="41px" style="text-align:center;">
                                           <?php echo $infodata->toArray()[0]['employee']['name'];?>
                                        </th>
                                    ...
                                    <tr>
                                        <td height="23px"><b>Date of Declaration</b></td>
                                        <td><?php if($sy_name=="2019-2020"){echo "18-March-2020";}else{ echo "16-March-2022";} ?></td>
                                        <td>Date of Issue</td>
                                        <td><?php if($sy_name=="2019-2020"){echo "18-March-2020";}else{  echo "16-March-2022";} ?></td>
                                    </tr>
                                </table>
                                ...
                                <table border="1"  cellspacing="0" cellpadding="0" style=" border-left: unset; width: 100.2%;text-transform: uppercase;margin-top: -6px;">
                                    <tr class="header_font main_color" >
                                        <th height="20" colspan="102" style="margin-left:5px;text-align:center;padding: 4px;color: white;">Attendance</th>
                                    </tr>
                                    <tr class="header_font second_color">
                                        <th height="30" width="22%"style="text-align:center;">Total Meetings</th>
                                    ...
                                    <tr class="header_sub">
                                        <th height="40px" style="text-align:center;">
                                          <?php
                                      ...
                                      foreach ($att as $attend_meeting){ 
										  ...
										  echo @$attend_meeting->total_meeting;
										 $componentData['meeting']=$attend_meeting->total_meeting;
										  }
}
										  ?>
										  
                                        </th>
                                        <th style="text-align:center;"><?php foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
										  echo @$attend_meeting->attend_meeting;
										   $componentData['attend']=$attend_meeting->attend_meeting;
										} }?></th>
										<?php  
										foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
										  ...
										  {
										 // echo @$attend_meeting->attend_meeting;
										  @$Percentageatt=@$attend_meeting->attend_meeting*100/@$attend_meeting->total_meeting;
										} }
										?>
				...
				<table width="100%"  border="1" style="margin-top:-4px;margin-bottom: -5px;" cellspacing="0" cellpadding="0" >
					...
					<td width="70%">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" >
							<tr  class="header_font main_color">
								<th height="20px" colspan="3" style="text-align:center;color:white;">Final Report</th>
							</tr>
							<tr >
								<th height="10px" width="50%" style="text-align:center;">Over All Grade</th>
								<td height="10px" width="50%" style="text-align:center;">
								<?php   //echo $neaddforpasspassnumber."/".$neaddforpasspasstotole;
							 	$overallpass=$neaddforpasspassnumber*100/$neaddforpasspasstotole;
								$componentData['marks']      = $neaddforpasspassnumber;
											$componentData['marksmax']      = $neaddforpasspasstotole;
											$componentData['percentage'] = round($overallpass,2);
								  foreach($infogread as $infog)
																	{
							...
							<tr>
								<th height="20px" style="text-align:center;">Result</th>
							...
							<tr>
								<th height="20px" style="text-align:center;">Promotion Granted to</th>
								<td style="text-align:center;">
								<?php 
								 $overallpass=$neaddforpasspassnumber/$neaddforpasspasstotole*100;
								if(round($overallpass)>=40){
								$bzzz=@$student->student_class->roman_name;$k=0;
								foreach($class_to_promotion as $key=>$axx){
								if($axx==$bzzz){
								$k =$key+1;
				...
				<table width="100%"  border="1" style="margin-top:-4px;margin-bottom: -5px;" cellspacing="0" cellpadding="0" >
					...
					<td width="70%">
						...
						if($countofsulimetri>0 && $countofsulimetri<=2)
							...
							<tr>
								<th height="30px" style="text-align:center;">Result</th>
								<td style="text-align:center;">
								<?php  
							...
							<tr>
                                  ...
                                  if($countofsulimetri<1)
								{
								 ...
								 $overallpass=$passtobeneed*100/$passtoneedallmarks;
								if(round($overallpass)>=33){
								$bzz=@$student->student_class->roman_name;$k=0;
								foreach($class_to_promotion as $key=>$axx){
								if($axx==$bzz){
								$k =$key+1;
								echo $class_to_promotion[$k];
					...
					<td width="30%">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" >
							<tr class="header_font main_color">
								<th height="23px" colspan="3" style="text-align:center;color:white;">Examination Seal</th>
							</tr>
							<tr>
    ...
    border-left: unset;" >
                                                <tbody>
                                                    <tr class="header_font main_color">
                                                        <th height="20" colspan="10" style="margin-left:5px;text-align:center;padding: 4px;color: white;">Part <?= $part ?> : <?= $type ?></th>
                                                    </tr>
													<?php if($subject['parentname']){?>
										<th class="header_font second_color" style="width: 25%;text-align: center !important;padding: 2px;font-weight: 600 !important;font-weight: 600!important;">Subject</th>
										<?php } ?>
													<th class="header_font second_color" style="width: 25%;text-align: center !important;padding:2px;font-weight: 600 !important;font-weight: 600!important;">Sub Subject</th>
													<?php $prdk=count($subject['student_marks']);
													if($prdk==1)
													{
													?>
                                    ...
                                    <?php } ?>
										...
										<td style="width: 25%;" rowspan="<?php echo $ii[$subject['parent_id']];?>"><p style="text-align: left!important;padding-left: 5px;padding: 2px;text-align: center !important;"><?= $subject['parentname'] ?></p></td>
										<?php } }?>
                                            <td style="width: 25%;"><p style="text-align: left!important;padding-left: 5px;padding: 2px;text-align: center !important;"><?= $subject['name'] ?></p></td>
...
<div class="row row-eq-height">
    ...
    border-left: unset;" >
                                                <tbody>
                                                    <tr class="header_font main_color">
                                                        <th height="20" colspan="10" style="margin-left:5px;text-align:center;padding: 2px;color: white;">Part <?= $part ?> : <?= $type ?></th>
                                                    </tr>
													
										<th class="header_font second_color" style="width: 25%;text-align: center !important;padding: 3px;font-weight: 600 !important;font-weight: 600!important;">Sr.No.</th>
                                    ...
                                    <?php } ?>
										...
										<td style="width: 25%;"><p style="text-align: left!important;padding-left: 5px;padding: 2px;text-align: center !important;"><?php echo $j;?></p></td>
                          ...
                          <table cellspacing="0px" cellpadding="0px" border="1" id="sample_1" style="text-transform: uppercase;margin-top: -5px;width: 100.2%;border-left: unset;" >
                            ...
                            <?php endif ?>
								...
								<?php  if($marks_type == 'Grade'){?>
										...
										<table width="100%" height="80px" border="1" cellspacing="0" cellpadding="0" style="text-align:center">
				<tr class="header_font main_color" >
					<th  colspan="6" height="25px" style="text-align:center;color: white;">PART 5 - RECORD OF ATTENDANCE</th>
				</tr>
				<tr class="header_font second_color">
					<th  height="28px" width="20%" style="text-align:center;"> SR. NO</th>
					<th width="20%" style="text-align:center;">PARTICULARS</th>
					<th width="20%" style="text-align:center;">RECORD I</th>
					<th width="20%" style="text-align:center;">RECORD II</th>
					<th width="20%" style="text-align:center;">RECORD III</th>
				</tr>
				<tr>
					<td  height="20px">1</td>
					<td>Number of Meeting</td>
					<td>
					<?php 
					$attendance1=0;$meeting1=0;
					$attendance2=0;$meeting2=0;
					...
					foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM I"){
												  echo $attend_meeting['total_meeting'];
												  $meeting1=$attend_meeting['total_meeting'];
										  }
										  }
					}
					?>
					...
					foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM II"){
												  echo $attend_meeting['total_meeting'];
												  $meeting2=$attend_meeting['total_meeting'];
										  }
										  }
					}
					?>
					...
					foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM III"){
												  echo $attend_meeting['total_meeting'];
												  $meeting3= $attend_meeting['total_meeting'];
												  $componentData['meeting'] = $attend_meeting['total_meeting'];
										  }
										  }
					}
					...
					foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM I"){
												  echo $attend_meeting['attend_meeting'];
												  $attendance1= $attend_meeting['attend_meeting'];
					...
					foreach ($att as $attend_meeting){ 
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM II"){
												  echo $attend_meeting['attend_meeting'];
												   $attendance2= $attend_meeting['attend_meeting'];
										  }
										  }
					}
					?>
										...
										//	pr($attend_meeting);
											if($attend_meeting['student_id']==$student->id)
										  {
											  if(strtoupper($attend_meeting['exam_master']['name'])=="TERM I"){
												...
												$per1  = round(($attend_meeting['attend_meeting']*100)/$attend_meeting['total_meeting'],2);
												if($per1>=90 && $per1<=100)
						{
							echo "Excellent";
							}
