        ...
        <div class="box box-primary">
            <div class="box-header printdata">
                <h3 class="box-title">
                 ...
                 <span class="caption-subject font-green-sharp bold " style="font-size: 16px;">Cross Section Report</span>
                </h3>
            </div>
            <div class="box-body padding " style="width: 100% !important;">
                ...
                <div class="table-responsive" id="table1">
                    ...
                    <h5 style="text-align:center; font-size:18px;"><b>Report of <?= @$classname['name']?>  >  <?php echo $classnamesection['name'];?></b></h5>
                    <div style="width: 100%;">
                        <table style="text-align: center;font-size: 18px;margin-top: 60px;" width="100%" border="1">
                            <thead>
                                <tr>
                            ...
                            <tbody id="main">
                                <?php
                                    $i=1;$x=0;$holds=0;$faileds=0;$passeds=0;$supp=0;
                                    foreach (@$alldeta as $dt) {
                                        if(empty($dt->student_info->roll_no)) continue;
										++$x;
										?>
                                    <tr>
                                        <td><?= $i;$i++; ?></td>
                                        ...
                                        <td><?= $dt->percentage ?></td>
                                        <td><?php 
                                           if($dt->status!="SUPPLEMENTARY" && @$student_records->status!='FAIL'){
									echo 	$dt->grade;
										
										   }?></td>
                                        <td><?php 
								if($dt->student_info->result_hold=="Hold")
								{    $holds+=1;
									echo "RWH";
								}
								else
				...
				<table class="table" border="0">
					<tbody>
						...
						<tr>
							<td>Result With Held</td>
							<td><?php echo $holds;?></td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
