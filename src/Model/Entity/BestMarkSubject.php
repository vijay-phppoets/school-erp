 ...
 * @property int $no_of_best_subject
 ...
 * @property \App\Model\Entity\BestMarkSubjectRow[] $best_mark_subject_rows
 */
class BestMarkSubject extends Entity
{
