 ...
 * Sports Model
 *
 * @property \App\Model\Table\SportRowsTable|\Cake\ORM\Association\HasMany $SportRows
 *
 ...
 * @method \App\Model\Entity\Sport|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class SportsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        /*$validator
            ->scalar('sport_image')
            ->maxLength('sport_image', 200)
            ->requirePresence('sport_image', 'create')
            ->notEmpty('sport_image'); */
