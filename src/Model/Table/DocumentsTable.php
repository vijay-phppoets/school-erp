 ...
 * Documents Model
 *
 * @property \App\Model\Table\DocumentClassMappingsTable|\Cake\ORM\Association\HasMany $DocumentClassMappings
 *
...
class DocumentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
       ...
       /* $validator
            ...
            ->maxLength('document_name', 30)
            ->requirePresence('document_name', 'create')
            ->notEmpty('document_name')
            ->add('document_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['document_name']));
