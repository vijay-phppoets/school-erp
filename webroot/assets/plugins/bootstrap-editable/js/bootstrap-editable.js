...
(function ($) {
    ...
    $.fn.editable.defaults = {
        ...
        formTemplate:'<form class="form-inline" autocomplete="off">' + 
                       ...
                       '&nbsp;<button type="submit" class="btn btn-primary"><i class="icon fa fa-check icon-white"></i></button>&nbsp;<button type="button" class="btn editable-cancel"><i class="icon-ban-circle"></i></button>' + 
