...
class AssignmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'assignment_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'medium_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'topic' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'document' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'session_year_id' => 1,
                'assignment_type' => 'Lorem ipsum dolor sit amet',
                'medium_id' => 1,
                'student_class_id' => 1,
                'stream_id' => 1,
                'section_id' => 1,
                ...
                'created_on' => 1545290947,
                'created_by' => 1,
                'edited_on' => 1545290947,
                'edited_by' => 1,
