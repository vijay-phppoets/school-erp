...
class SectionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'session_year_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'sections' => ['type' => 'unique', 'columns' => ['name', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'session_year_id' => 1,
                'created_on' => 1541501074,
                'created_by' => 1,
                'edited_on' => 1541501074,
                'edited_by' => 1,
