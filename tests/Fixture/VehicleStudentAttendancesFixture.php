...
/**
 * VehicleStudentAttendancesFixture
 *
 */
class VehicleStudentAttendancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'taken_by' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'taken_by' => 1,
                'date' => '2018-10-29',
                'created_on' => 1540796117,
                'created_by' => 1,
                'edited_on' => 1540796117,
                'edited_by' => 1
            ],
        ];
        parent::init();
