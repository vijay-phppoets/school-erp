...
class FeeCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'Regular/Adhoc/Yearly/Once IN A Life Time', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fee_categories' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fee_collection' => 'Lorem',
                'created_on' => 1542101745,
                'created_by' => 1,
                'edited_on' => 1542101745,
                'edited_by' => 1,
