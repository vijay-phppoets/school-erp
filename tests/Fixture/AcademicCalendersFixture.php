...
class AcademicCalendersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'academic_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'employee_id' => 1,
                'created_on' => 1545203821,
                'created_by' => 1,
                'edited_on' => 1545203821,
                'edited_by' => 1,
