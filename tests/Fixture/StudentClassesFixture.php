...
class StudentClassesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'roman_name' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'session_year_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'order_of_class' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'grade_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'name_session_year_id' => ['type' => 'unique', 'columns' => ['name', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'roman_name' => 'Lorem ipsum dolor ',
                'session_year_id' => 1,
                'order_of_class' => 1,
                'grade_type' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1543656288,
                'created_by' => 1,
                'edited_on' => 1543656288,
                'edited_by' => 1,
