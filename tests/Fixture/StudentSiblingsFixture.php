...
/**
 * StudentSiblingsFixture
 *
 */
class StudentSiblingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sibling_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'student_siblings' => ['type' => 'unique', 'columns' => ['student_id', 'sibling_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sibling_id' => 1,
                'session_year_id' => 1,
                'created_on' => 1543489656,
                'created_by' => 1,
                'edited_on' => 1543489656,
                'edited_by' => 1,
