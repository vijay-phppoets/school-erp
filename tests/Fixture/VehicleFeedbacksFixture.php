...
/**
 * VehicleFeedbacksFixture
 *
 */
class VehicleFeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'vehicle_feedbacks_ibfk_1' => ['type' => 'foreign', 'columns' => ['student_id'], 'references' => ['students', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1540795960,
                'created_by' => 1,
                'edited_on' => 1540795960,
                'edited_by' => 1
            ],
        ];
        parent::init();
