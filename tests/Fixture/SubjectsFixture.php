...
class SubjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'elective' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'subject_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'name_student_class_id_stream_id_session_year_id' => ['type' => 'unique', 'columns' => ['name', 'student_class_id', 'stream_id', 'session_year_id'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lft' => 1,
                'rght' => 1,
                'elective' => 'Lorem ipsum dolor sit amet',
                'subject_type_id' => 1,
                'order_number' => 1,
                'created_on' => 1543656105,
                'created_by' => 1,
                'edited_on' => 1543656105,
                'edited_by' => 1,
