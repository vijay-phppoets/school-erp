...
class ComplaintsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'session_year_id' => ['type' => 'index', 'columns' => ['session_year_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'complaints_ibfk_1' => ['type' => 'foreign', 'columns' => ['student_id'], 'references' => ['students', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'complaints_ibfk_2' => ['type' => 'foreign', 'columns' => ['session_year_id'], 'references' => ['session_years', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'student_id' => 1,
                'employee_id' => 1,
                'created_on' => 1545978711,
                'created_by' => 1,
                'edited_on' => 1545978711,
                'edited_by' => 1,
