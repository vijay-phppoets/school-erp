...
class PollsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'poll_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'poll_type' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1545800399,
                'created_by' => 1,
