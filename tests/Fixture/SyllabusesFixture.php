...
class SyllabusesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_path' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1545803142,
                'created_by' => 1,
                'edited_on' => 1545803142,
                'edited_by' => 1,
