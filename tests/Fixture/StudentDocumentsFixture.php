...
/**
 * StudentDocumentsFixture
 *
 */
class StudentDocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'document_class_mapping_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'image_path' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'student_documents' => ['type' => 'unique', 'columns' => ['student_id', 'document_class_mapping_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'document_class_mapping_id' => 1,
                'image_path' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1545463785,
                'created_by' => 1,
                'edited_on' => 1545463785,
                'edited_by' => 1
            ],
        ];
        parent::init();
