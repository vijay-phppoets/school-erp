...
class FeeTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'Tution Fee/Bus Fee', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'name_fee_category_id' => ['type' => 'unique', 'columns' => ['name', 'fee_category_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1542172195,
                'created_by' => 1,
                'edited_on' => 1542172195,
                'edited_by' => 1
            ],
        ];
        parent::init();
