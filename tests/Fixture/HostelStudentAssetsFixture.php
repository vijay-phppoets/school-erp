...
/**
 * HostelStudentAssetsFixture
 *
 */
class HostelStudentAssetsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'hostel_room_asset_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'student_id' => 1,
                'session_year_id' => 1,
                'hostel_room_asset_id' => 1,
                'quantity' => 1,
                'status' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1542608829,
                'created_by' => 1,
                'edited_on' => 1542608829,
                'edited_by' => 1
            ],
        ];
        parent::init();
