...
class StockLedgersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'In/Out', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'location_id' => 1,
                'quantity' => 1.5,
                'transaction_date' => '2018-11-09',
                'status' => 'Lorem ip',
                'created_on' => 1541785414,
                'created_by' => 1,
                'edited_on' => 1541785414,
                'edited_by' => 1
            ],
        ];
        parent::init();
