...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'guest_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1546057993,
                'created_by' => 1,
                'edited_on' => 1546057993,
                'edited_by' => 1,
