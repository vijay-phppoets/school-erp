...
class RoomsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'room_no' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'hostel_id_room_no' => ['type' => 'unique', 'columns' => ['hostel_id', 'room_no'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'hostel_id' => 1,
                'room_no' => 'Lorem ipsum dolor ',
                'room_capacity' => 1,
                'created_on' => 1542368929,
                'created_by' => 1,
                'edited_on' => 1542368929,
                'edited_by' => 1,
