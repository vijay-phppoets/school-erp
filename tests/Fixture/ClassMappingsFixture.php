...
/**
 * ClassMappingsFixture
 *
 */
class ClassMappingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'class_mappings' => ['type' => 'unique', 'columns' => ['student_class_id', 'medium_id', 'stream_id', 'section_id', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1545220624,
                'created_by' => 1,
                'edited_on' => 1545220624,
                'edited_by' => 1
            ],
        ];
        parent::init();
