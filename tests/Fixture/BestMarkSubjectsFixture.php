...
/**
 * BestMarkSubjectsFixture
 *
 */
class BestMarkSubjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'no_of_best_subject' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'session_year_id_student_class_id_stream_id_subject_id' => ['type' => 'unique', 'columns' => ['session_year_id', 'student_class_id', 'stream_id', 'subject_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'stream_id' => 1,
                'subject_id' => 1,
                'no_of_best_subject' => 1,
                'created_on' => 1543485681,
                'created_by' => 1,
                'edited_on' => 1543485681,
                'edited_by' => 1,
