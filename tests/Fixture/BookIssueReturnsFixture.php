...
/**
 * BookIssueReturnsFixture
 *
 */
class BookIssueReturnsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'late_day' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'fine_amount_per_day' => ['type' => 'decimal', 'length' => 8, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'fine_amount' => ['type' => 'decimal', 'length' => 8, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'status' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'Paid / Unpaid', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'session_year_id' => 1,
                'employee_id' => 1,
                'date_from' => '2018-11-03',
                'date_to' => '2018-11-03',
                'return_date' => '2018-11-03',
                'late_day' => 1,
                'fine_amount_per_day' => 1.5,
                'fine_amount' => 1.5,
                'status' => 'Lorem ipsum d',
                'remark' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'created_on' => 1541245163,
                'created_by' => 1,
                'edited_on' => 1541245163,
                'edited_by' => 1
            ],
        ];
        parent::init();
