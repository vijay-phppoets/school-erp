...
/**
 * ItemIssueReturnsFixture
 *
 */
class ItemIssueReturnsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'Issue/Return', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'grand_total' => 1.5,
                'created_on' => 1542652290,
                'created_by' => 1,
                'edited_on' => 1542652290,
                'edited_by' => 1
            ],
        ];
        parent::init();
