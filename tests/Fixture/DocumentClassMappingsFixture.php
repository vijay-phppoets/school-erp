...
/**
 * DocumentClassMappingsFixture
 *
 */
class DocumentClassMappingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'session_year_id_document_id_student_class_id' => ['type' => 'unique', 'columns' => ['session_year_id', 'document_id', 'student_class_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'document_id' => 1,
                'student_class_id' => 1,
                'created_on' => 1545463670,
                'created_by' => 1,
                'edited_on' => 1545463670,
                'edited_by' => 1,
