...
class PurchaseReturnsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'voucher_no' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'remark' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'grand_total' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'purchase_returns' => ['type' => 'unique', 'columns' => ['voucher_no', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'grand_total' => 1.5,
                'created_on' => 1542483299,
                'created_by' => 1,
                'edited_on' => 1542483299,
                'edited_by' => 1
            ],
        ];
        parent::init();
