...
class PurchaseOrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'po_no' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'trasaction_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'purchase_orders' => ['type' => 'unique', 'columns' => ['po_no', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'vendor_id' => 1,
                'session_year_id' => 1,
                'trasaction_date' => '2018-11-11',
                'created_on' => 1541895312,
                'created_by' => 1,
                'edited_on' => 1541895312,
                'edited_by' => 1
            ],
        ];
        parent::init();
