...
/**
 * FeeTypeMastersFixture
 *
 */
class FeeTypeMastersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'optional' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'fee_wise' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'student_wise' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fee_type_masters' => ['type' => 'unique', 'columns' => ['session_year_id', 'fee_category_id', 'fee_type_id', 'vehicle_station_id', 'gender_id', 'student_class_id', 'medium_id', 'stream_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'medium_id' => 1,
                'stream_id' => 1,
                'fee_wise' => 'Lorem ipsum dolor sit amet',
                'student_wise' => 'Lorem ipsum dolor sit amet',
                'is_deleted' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1542371759,
                'created_by' => 1,
                'edited_on' => 1542371759,
                'edited_by' => 1
            ],
        ];
        parent::init();
