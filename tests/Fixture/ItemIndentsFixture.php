 ...
 *
 */
class ItemIndentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'item_indents' => ['type' => 'unique', 'columns' => ['voucher_no', 'session_year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1541249302,
                'created_by' => 1,
                'edited_on' => 1541249302,
                'edited_by' => 1
            ],
        ];
        parent::init();
