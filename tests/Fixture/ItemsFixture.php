...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'item_subcategory_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'items' => ['type' => 'unique', 'columns' => ['item_category_id', 'item_subcategory_id', 'name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1541747489,
                'created_by' => 1,
                'edited_on' => 1541747489,
                'edited_by' => 1,
