...
class DocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'document_name' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'document_name' => ['type' => 'unique', 'columns' => ['document_name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1545463631,
                'created_by' => 1,
                'edited_on' => 1545463631,
                'edited_by' => 1,
