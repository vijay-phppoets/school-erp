...
/**
 * StudentParentProfessionsFixture
 *
 */
class StudentParentProfessionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'student_parent_professions' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_on' => 1542092095,
                'created_by' => 1,
                'edited_on' => 1542092095,
                'edited_by' => 1,
