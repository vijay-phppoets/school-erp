...
/**
 * HostelRoomAssetsFixture
 *
 */
class HostelRoomAssetsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'default_item' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'item_code' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'default_item' => 'Lorem ipsum dolor sit amet',
                'item_code' => 'Lorem ipsum dolor sit amet',
                'created_on' => 1542793523,
                'created_by' => 1,
                'edited_on' => 1542793523,
                'edited_by' => 1,
