...
class NoticesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notice_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'notice_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'doc' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'valid_from' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'valid_to' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'notice_type' => 'Lorem ipsum dolor sit amet',
                'doc' => 'Lorem ipsum dolor sit amet',
                'valid_from' => '2018-11-24',
                'valid_to' => '2018-11-24',
                'created_on' => 1543055417,
                'created_by' => 1,
                'edited_on' => 1543055417,
                'edited_by' => 1,
